...
-- Table of layoutst to cover with awful.layout.inc, order matters.
local layouts =
{
...
for s = 1, screen.count() do
   ...
   tags[s] = awful.tag({ "1", "2", "3", "4", "5"}, s, tags.layouts)
end
myawesomemenu = {
...
menubar.utils.terminal = lxterminal
-- }}}
-- {{{ Wibox
-- Network usage Widget
netwidget = wibox.widget.textbox()
vicious.register(netwidget, vicious.widgets.net, '<span color="#CC9393">${eth0 down_kb}</span> <span color="#7F9F7F">${wlan0 up_kb}</span>', 3)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "o", awful.tag.history.restore),
